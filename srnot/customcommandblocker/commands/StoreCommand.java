...
/*    */   
/*    */   public StoreCommand(customcommandblocker plugin) {
...
/* 32 */     String Path = "Config.Command-Store";
/* 33 */     if (config.getString(Path).equals("true")) {
/* 34 */       List<String> mensaje = config.getStringList("Config.Store-Message");
...
/* Location:              C:\Users\D2SIADO\Downloads\CustomCommandBlocker-Beta.v1.0.jar!\srnot\customcommandblocker\commands\StoreCommand.class
